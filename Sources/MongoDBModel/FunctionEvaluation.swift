...
internal extension FetchRequest {
    ...
    /// therefore requires in-memory evaluation — MongoDB cannot execute a custom
    /// function as part of a native query.
...
internal extension FetchRequest.Predicate {
    ...
    /// remaining predicate can be executed natively by MongoDB as a superset filter.
